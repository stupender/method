...
export const A5: Interval = { name: 'A5', diatonicSteps: 4, semitones: 8 };  // augmented 5th (sharp 5)
export const m6: Interval = { name: 'm6', diatonicSteps: 5, semitones: 8 };  // minor 6th (flat 6)
export const M6: Interval = { name: 'M6', diatonicSteps: 5, semitones: 9 };  // major 6th
export const d7: Interval = { name: 'd7', diatonicSteps: 6, semitones: 9 };  // diminished 7th
